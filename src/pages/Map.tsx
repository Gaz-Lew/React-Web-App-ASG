...
function KnockModal({
  ...
  const inp = 'w-full px-2 py-1.5 rounded-lg border border-gray-300 dark:border-white/[0.08] bg-white dark:bg-[var(--surface)] text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-400';
      ...
      <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4">
        <div className="bg-white dark:bg-[var(--surface)] rounded-xl shadow-2xl w-full max-w-md">
          <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200 dark:border-white/[0.06]">
            ...
            <button onClick={onClose} className="p-1 hover:bg-gray-100 dark:hover:bg-[var(--hover)] rounded transition"><X size={16} /></button>
          </div>
          ...
          <div className="flex gap-3 px-5 py-4 border-t border-gray-200 dark:border-white/[0.06]">
            <button onClick={onClose} className="flex-1 py-2 rounded-lg border border-gray-300 dark:border-white/[0.08] text-gray-700 dark:text-gray-300 text-sm hover:bg-gray-50 dark:hover:bg-[var(--hover)] transition">Cancel</button>
                ...
                {reps.map((r) => (
                  ...
                  >
                    <span className={`w-4 h-4 rounded border-2 flex items-center justify-center flex-shrink-0 transition ${
                      selectedRepIds.has(r.id) ? 'bg-amber-500 border-amber-500' : 'border-gray-300 dark:border-white/[0.08]'
                    }`}>
        ...
        {expanded && (
          <>
            ...
            <div className="py-1.5">
              {allPinTypes.map((pt) => (
                <div key={pt.id} className="flex items-center justify-between px-3 py-1.5 hover:bg-gray-50 dark:hover:bg-[var(--hover)] transition group">
            ...
            <div className={`px-3 pt-1 border-t border-gray-100 dark:border-white/[0.06] ${showNewPin ? '' : 'pb-2.5'}`}>
...
function PinActionPanel({
  ...
  const inp = 'w-full px-2.5 py-1.5 rounded-lg border border-gray-300 dark:border-white/[0.08] bg-white dark:bg-[var(--surface)] text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-400';
      ...
      <div className="fixed inset-x-0 bottom-0 z-50 sm:inset-auto sm:bottom-auto sm:top-1/2 sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:w-full sm:max-w-sm p-3 sm:p-0">
        <div className="bg-white dark:bg-[var(--surface)] rounded-2xl shadow-2xl overflow-hidden max-h-[85vh] sm:max-h-[80vh] flex flex-col">
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-white/[0.06] flex-shrink-0">
            ...
            <button onClick={onClose} className="p-1.5 hover:bg-gray-100 dark:hover:bg-[var(--hover)] rounded-lg transition text-gray-400 flex-shrink-0 ml-2">
              <X size={15} />
            </button>
          </div>
        ...
        {overlaysVisible && showZoneLibrary && (
          <div className="absolute top-0 right-0 bottom-0 w-72 bg-white dark:bg-[var(--surface)] border-l border-gray-200 dark:border-white/[0.06] z-20 flex flex-col shadow-2xl">
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-white/[0.06]">
              ...
              <button onClick={() => setShowZoneLibrary(false)} className="p-1 hover:bg-gray-100 dark:hover:bg-[var(--hover)] rounded transition text-gray-400"><X size={15} /></button>
            </div>
            {/* Date range filter */}
            ...
            <div className="flex-1 overflow-y-auto">
              {filteredZones.length === 0 ? (
                ...
                <ul className="divide-y divide-gray-100 dark:divide-slate-800">
                  {filteredZones.map((zone) => (
                    <li key={zone.id} className="flex items-start gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-[var(--hover)]/50 transition group">
