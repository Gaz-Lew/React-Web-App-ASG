...
assert.match(appShell, /const sidebarBrand = \(/, "region workspace control should live with the sidebar brand.");
assert.match(appShell, /WorkspaceSwitcher/, "sidebar brand should render the shared workspace switcher.");
